                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in previewbet" :key="index">
                            ...
                            <td>
                                <div class="text-right"> {{ item.betprice |currency(setting.general.symbol )}}</div>
                            </td>
                            <td>
                                <div class="text-right"> {{ item.betdiscount |currency(setting.general.symbol ) }}</div>
                            </td>
                            <td>
                                <div class="text-right"> {{ item.betpay  |currency(setting.general.symbol )}}</div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                            ...
                            <td>
                                ...
                                <div class="text-right">{{ totalBet | currency(setting.general.symbol ) }}</div>
