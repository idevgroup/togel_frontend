<template>
    <div>
        ...
        <p>
            ...
            <span> 2D Depan Max Bet: {{ marketGameSetting.max_bet |currency(setting.general.symbol, 2, { thousandsSeparator: ',',spaceBetweenAmountAndSymbol: true })}} </span>
            <span> 2D Depan Discount: {{ marketGameSetting.discount }}%</span>
            <span> 2D Depan Bet Modulus: {{ marketGameSetting.bet_mod |currency(setting.general.symbol, 2, { thousandsSeparator: ',',spaceBetweenAmountAndSymbol: true })}}</span>
            <span> Win 2D Depan: x {{ marketGameSetting.menang }}</span>
        </p>
